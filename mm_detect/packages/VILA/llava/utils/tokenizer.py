...
from VILA.llava import conversation as conversation_lib
from VILA.llava.constants import IGNORE_INDEX
from VILA.llava.mm_utils import tokenizer_image_token
